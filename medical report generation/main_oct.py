...
# from models.r2genUPD-version2 import R2GenModel
from models.r2genUPD_version2 import R2GenModel
...
# /root/work2023/use_image_captioning-main/oct/karpathy/oct_annotation13_mini.json
# /root/work2023/use_image_captioning-main/oct/karpathy/oct_annotation11_baidu.json
    ...
    # Trainer settings
    parser.add_argument('--gpu_index', type=str, default='cuda:0', help='the number of gpus to be used.')
    ...
    parser.add_argument('--save_dir', type=str, default='/root/work2023/use_R2gen_rewrite/result6/', help='the patch to save the models.')
    parser.add_argument('--record_dir', type=str, default='/root/work2023/use_R2gen_rewrite/records/', help='the patch to save the results of experiments')
    parser.add_argument('--save_period', type=int, default=1, help='the saving period.')
    parser.add_argument('--monitor_mode', type=str, default='max', choices=['min', 'max'], help='whether to max or min the metric.')
    parser.add_argument('--monitor_metric', type=str, default='BLEU_4', help='the metric to be monitored.')
    parser.add_argument('--early_stop', type=int, default=8, help='the patience of training.')
...
def main():
    ...
    for param in model.multilabel.parameters():
