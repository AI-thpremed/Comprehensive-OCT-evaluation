...
def main():
    ...
    taskname='_resnet152_org_top5_smalldata_75'
    ...
    TRAIN_LISTS = ['train_data_top5_75.csv']
    ...
    # predict_model = torch.load("/root/work2023/deep-learning-for-image-processing-master/pytorch_classification/Test5_resnet/resnet50-pre.pth")
    ...
    net.fc = nn.Sequential(nn.Linear(net.fc.in_features, len(CLASSES)),
                                 nn.Sigmoid())
    ...
    for epoch in range(epochs):
        ...
        if epoch > epochs-3:
            torch.save(net.state_dict(), path+'/resNet50'+taskname+'_'+str(epoch)+'.pth')
